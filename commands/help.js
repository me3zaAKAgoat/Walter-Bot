		...
		try {
			...
			const commandDescription = {
				poll: {
					command: "/poll",
					description:
						"Your title could any normal sentence, but your options must be separated by a comma. e.g: option1, option 2, option 3",
				},
				rank: {
					command: "/rank",
					description:
				...
				movie: {
					command: "/movie",
					description:
						"This command provides a database for your server to make your own collection of movies, and with your input, it can keep movies with their ratings, these ratings are calculated by averaging each member's rating.\n*P.S: Rating movies renders them ‘seen’ so they won’t show up in the (movie randomize) spinning wheel, meaning that you should not review a film that your friend group did not watch together.*",
				},
				configure: {
					command: "/configure",
					description:
